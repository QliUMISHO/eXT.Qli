...
<div class="wf-app" data-page="logs">
    <div class="wf-shell">
        <div class="wf-sidebar">
            ...
            <div class="wf-nav">
                ...
                <div class="wf-nav-item wf-nav-active" data-link="/logs">Logs</div>
                <div class="wf-nav-item wf-nav-danger" id="logout_button">Logout</div>
            </div>
        </div>
        <div class="wf-main">
            <div class="wf-topbar">
                <div class="wf-title">Block Logs</div>
                <div class="wf-user"><?php echo htmlspecialchars($adminName, ENT_QUOTES, 'UTF-8'); ?></div>
            </div>
            <div class="wf-panel">
                <div class="wf-panel-title">Recent Block Events</div>
                <div id="logs_table" class="wf-table"></div>
            </div>
        </div>
    </div>
